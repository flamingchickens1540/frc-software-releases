...
> Our robot specialized in capping stacks of boxes with the recycling cylinder to get maximum points. This code features some interesting bits that were later turned into their own seperate libraries, like the [sensors package](https://github.com/Team4761/2015-Robot-Code/tree/master/src/org/usfirst/frc/team4761/robot/sensors) (see [DistanceSensorLib](https://github.com/Team4761/DistanceSensorLib) and the [button management system](https://github.com/Team4761/2015-Robot-Code/blob/master/src/org/usfirst/frc/team4761/robot/ButtonManager.java) (see [ButtonManager](https://github.com/Team4761/ButtonManager)). There is also the [gyro code](https://github.com/Team4761/2015-Robot-Code/blob/master/src/org/usfirst/frc/team4761/robot/sensors/GyroSensor.java) which adds some support for the I2C powered MPU-6050 gyro. It is in the command-based structure and pretty well documented so go start exploring!
